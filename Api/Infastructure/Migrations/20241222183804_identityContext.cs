        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountToBePaid = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfReservedBeds = table.Column<int>(type: "integer", nullable: false),
                    RoomNumber = table.Column<int>(type: "integer", nullable: false),
                    PricePerBed = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseCourseCost = table.Column<int>(type: "integer", nullable: true),
                    BaseCourseCostPerPerson = table.Column<int>(type: "integer", nullable: true),
                    CurrentlySigned = table.Column<int>(type: "integer", nullable: true),
                    MaxPeople = table.Column<int>(type: "integer", nullable: true),
                    PrivateSession = table.Column<bool>(type: "boolean", nullable: true),
                    AdjustingPriceForPrivateSession = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomReservations_AppUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                name: "CourseUserAssigments",
                columns: table => new
                {
                    CourseAssigmentId = table.Column<int>(type: "integer", nullable: false),
                    AppUserId = table.Column<int>(type: "integer", nullable: false),
                    NumberOfPeopleSigningUp = table.Column<int>(type: "integer", nullable: false),
                    AmountPaid = table.Column<int>(type: "integer", nullable: false),
                    AmountToBePaid = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUserAssigments", x => new { x.CourseAssigmentId, x.AppUserId });
                    table.ForeignKey(
                        name: "FK_CourseUserAssigments_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseUserAssigments_CourseAssignments_CourseAssigmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseUserAssigments_AppUserId",
                table: "CourseUserAssigments",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomReservations_AppUserId",
